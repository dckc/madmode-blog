---
title: 1000mi on an e-bike in OP KS
tags:
  - e-bike
  - climate
  - shopping
...
> People should have the option to live in a neighborhood where it is safe, easy, and comfortable to walk, bike, or take the bus to get your groceries, prescriptions, go to church, or eat at your favorite restaurant.
...
_p.s. did you know the [Internet Archive](https://archive.org/) has a policy to [welcome image hosting](https://archive.org/post/1078822/archiveorg-as-media-file-host)?_

_I didn't see cc-by among the license options though. odd._

---

_p.p.s. [obsidian](https://obsidian.md/) works pretty well for writing photo essay blog items. It doesn't put a blank line between the yaml and the copy, though; I had to fix that with a plain text editor._
